...
<!-- Slider -->
<link rel="stylesheet" href="<?php echo base_url() ?>assets/web/css/tiny-slider.css" />
<link href="<?php echo base_url() ?>assets/web/css/swiper.min.css" rel="stylesheet" type="text/css" />
<!-- Main Css -->
